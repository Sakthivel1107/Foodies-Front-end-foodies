          ...
          <div className="card-body p-4 p-sm-5">
            ...
            <form onSubmit={onSubmitHandler}>
              <div className="form-floating mb-3">
                <input type="text" className="form-control" id="floatingName" placeholder="Jack Sparrow" name="name" onChange={onChangeHandler} value={data.name} required/>
              ...
              <div className="mt-4">
                Already have an Account? <Link className='text-decoration-none' to="/login">Sign in</Link>
              </div>
            </form>
          </div>
        </div>
